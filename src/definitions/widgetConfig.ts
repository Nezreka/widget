...
export const AVAILABLE_WIDGET_DEFINITIONS: WidgetBlueprint[] = [
  ...
  { type: 'youtube', defaultTitle: 'YouTube Player', displayName: 'YouTube', description: "Embed YouTube to watch videos.", icon: YoutubeIcon, defaultSizePreset: 'content_driven_large', minColSpan: 10, minRowSpan: 8, defaultSettings: {} },
